<template>
        ...
        <div id="footerSocial" class="w-full my-5 border border-gray-400 p-3"> 
            ...
            <div class="grid md:grid-rows-3 md:grid-cols-2 md:gap-10 lg:grid-rows-2 lg:grid-cols-3 lg:gap-10">
                <a href="https://www.pinterest.co.uk/cameronpaton86/" target="_blank"><img class="h-8 w-8 md:h-12 md:w-12" src="@/assets/images/pinterest.png" alt="pinterest Camdev Cameron Paton"></a>
